...
<div class="row">
	<div class="col-xs-12 text-right">
		<a href="<?php echo $plugin->getRulesController()->getUrl(['do'=>'new']) ?>" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-plus-sign" style="margin-right: 5px"></i> <?php _e( 'Add An Automation', 'mwp-rules' ) ?></a>
