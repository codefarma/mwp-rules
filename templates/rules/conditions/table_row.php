...
<div class="operation-row condition-row">
...
<div class="operation-children condition-children">
	<?php if ( $subconditions ) : ?>
		<?php
			$table = $controller->createDisplayTable();
			$table->prepare_items( array( 'condition_rule_id=%d AND condition_parent_id=%d', $condition->rule_id, $condition->id ) );
